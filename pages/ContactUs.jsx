...
function Index() {
  ...
  return (
    ...
    <div className='w-full h-full z-50 text-center flex flex-row justify-center pt-96 pb-36'>

    
    <h1>We have received your query successfully<br />Thankyou for reaching out to us.</h1>
    </div>
