...
function Events() {
  ...
  return (
    ...
    <div className="gradient-blue h-auto  justify-center w-full  font-mulish flex flex-col text-xl sm:pt-[5vmax] md:pt-[5vmax] xl:pt-[5vmax] lg:pt-[5vmax] pt-[6.6vmax] overflow-clip  text-[#F9F9F9] " >
